define(function(require, exports, module) {
    ...
    var initStruct=function(opts){
        ...
        $canvas.attr('width',w*2).attr('height',w*2)
                .css({
                    width:w,
                    height:w,
                    left:ww>divideWindowSize?w*0.45:w*0.18,
                    right:w*0.2
                });
        ...
        $canvas.each(function(index,item){
            ...
            setTimeout(function(){
                ...
                span.style.left=ww>divideWindowSize?'50%':'38%';
    ...
    var initKey=function(opts){
        ...
        wordCloud.draw(keys,null,{
            ...
            maxFontSize:ww>divideWindowSize?40:28,
            minFontSize:ww>divideWindowSize?16:12
        });
    }
